...
public:
   ...
   virtual void SettleForIndependentExitT1727() { }
   ...
   virtual bool OperationScope(const ulong id,const long nonce,long &serial,int &direction) const {return false;}
   virtual bool OutcomeConsumed(const ulong positionId,const long nonce) const { return false; }
