...
// T17.27: Core-only cap. Generic RH/close normalization is unchanged.
double Grid_NormalizeCoreVolume(const double lot)
{
   return Unit_CappedVolumePure(lot,Cfg.MaxLot,
